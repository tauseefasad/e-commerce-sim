...
public class Product
{
	...
	private String name;
	private String id;
	private com.company.Product.Category category;
	...
	public Product()
	{
		this.name = "Product";
		this.id = "001";
		this.category = com.company.Product.Category.GENERAL;
		this.stockCount = 0;
	}

	public Product(String id)
	{
		this("Product", id, 0, 0, com.company.Product.Category.GENERAL);
	}

	public Product(String name, String id, double price, int stock, com.company.Product.Category category)
	{
		this.name = name;
		this.id = id;
		this.price = price;
	...
	public com.company.Product.Category getCategory()
	{
		return category;
	}
	...
	{
		com.company.Product otherP = (com.company.Product) other;
