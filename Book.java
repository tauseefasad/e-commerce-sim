...
public class Book extends Product
{
    ...
    public boolean validOptions(String productOptions)
    {
        ...
        if ((!productOptions.equals("Paperback")) && (!productOptions.equals("Hardcover")) && (!productOptions.equals("EBook"))){
            return false; //it will return false if it does not match with "Paperback" or "Hardcover" or "EBook"

        }
        return true; //it will return true if it matches "Paperback" or "Hardcover" or "EBook"
    }
    ...
    public int getStockCount(String productOptions)
    {
        ...
        if(productOptions.equals("Paperback")){  // used productOptions to return the stock number for "Paperback"
    ...
    public void setStockCount(int stockCount, String productOptions)
    {
        ...
        if(productOptions.equals("Paperback")){ //used productOption to set the number of stock
    ...
    public void print()
    {
        ...
        super.print();
        System.out.print(" Book Title: " + title + " Author: " + author); // replaces the line
    }
